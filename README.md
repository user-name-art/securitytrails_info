...
Имя домена нужно передавать в аргументах без http/https и слэшей. Возможно, в дальнейшем появится "очистка" от протоколов и слэшей, но пока этого нет. Начиная с версии 1.03 скрипт умеет работать с кириллическими доменами, теперь их не нужно самоятоятельно преобразовывать в Punycode.
